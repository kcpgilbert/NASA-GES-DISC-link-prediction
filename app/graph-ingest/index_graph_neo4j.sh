...
python neo4j-node-dataset-index-new.py 
...
python neo4j-node-instrument-index-new.py

#python neo4j-node-investigator-index.py
python neo4j-node-investigator-index-new.py
...
python neo4j-edge-dataset-instrument-index-new.py

#python neo4j-edge-dataset-investigator-index.py
python neo4j-edge-dataset-investigator-index-new.py

#python neo4j-gds-fastrp.py
python neo4j-gds-fastrp-new.py
